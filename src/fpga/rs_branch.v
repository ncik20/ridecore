...
module rs_branch_ent
  (
   ...
   // input wire 			          wprcond,
   input wire [`FTQ_SEL-1:0]      wftq_idx,
   input wire [3:0]               wpc_offset,
   ...
   // output reg 			  prcond,
   output reg [`FTQ_SEL-1:0]      ftq_idx,
   output reg [3:0]               pc_offset,
...
module rs_branch
  (
   ...
   input wire [`FTQ_SEL-1:0]      wftq_idx_1,
   input wire [3:0]               wpc_offset_1,
   ...
   input wire [`FTQ_SEL-1:0]      wftq_idx_2,
   input wire [3:0]               wpc_offset_2,
   ...
   // output wire 			     prcond,
   output wire [`FTQ_SEL-1:0]      ftq_idx,
   output wire [3:0]               pc_offset,
   ...
   // wire 			     prcond_0;
   wire [`FTQ_SEL-1:0]      ftq_idx_0;
   wire [3:0]               pc_offset_0;
   ...
   // wire 			     prcond_1;
   wire [`FTQ_SEL-1:0]      ftq_idx_1;
   wire [3:0]               pc_offset_1;
   ...
   // wire 			     prcond_2;
   wire [`FTQ_SEL-1:0]      ftq_idx_2;
   wire [3:0]               pc_offset_2;
   ...
   // wire 			     prcond_3;
   wire [`FTQ_SEL-1:0]      ftq_idx_3;
   wire [3:0]               pc_offset_3;
   ...
   rs_branch_ent ent0(
		      ...
		      .wftq_idx((we1 && (waddr1 == 0)) ? wftq_idx_1 : wftq_idx_2),
		      .wpc_offset((we1 && (waddr1 == 0)) ? wpc_offset_1 : wpc_offset_2),
   ...
   rs_branch_ent ent1(
		      ...
		      .wftq_idx((we1 && (waddr1 == 1)) ? wftq_idx_1 : wftq_idx_2),
		      .wpc_offset((we1 && (waddr1 == 1)) ? wpc_offset_1 : wpc_offset_2),
   ...
   rs_branch_ent ent2(
		      ...
		      .wftq_idx((we1 && (waddr1 == 2)) ? wftq_idx_1 : wftq_idx_2),
		      .wpc_offset((we1 && (waddr1 == 2)) ? wpc_offset_1 : wpc_offset_2),
   ...
   rs_branch_ent ent3(
		      ...
		      .wftq_idx((we1 && (waddr1 == 3)) ? wftq_idx_1 : wftq_idx_2),
		      .wpc_offset((we1 && (waddr1 == 3)) ? wpc_offset_1 : wpc_offset_2),
...
*/
   assign ftq_idx = (issueaddr == 0) ? ftq_idx_0 :
		(issueaddr == 1) ? ftq_idx_1 :
		(issueaddr == 2) ? ftq_idx_2 : ftq_idx_3;
   
   assign pc_offset = (issueaddr == 0) ? pc_offset_0 :
		   (issueaddr == 1) ? pc_offset_1 :
		   (issueaddr == 2) ? pc_offset_2 : pc_offset_3;
