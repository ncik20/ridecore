	...
	always_comb begin
		...
		case(req_addr[3:2])
			2'b00:data_write[31-: 32] = (cpu_req_funct3 == 3'b000) ?
              store_b(req_addr[1:0], data_write[31-: 32], cpu_req_data[7:0]) :
